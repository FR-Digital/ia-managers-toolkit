...
## À Propos de LaFabriqAI

**LaFabriqAI** crée des outils open-source pour démystifier l'IA pour les managers non-techniques.

Notre mission : donner aux décideurs les moyens de piloter des projets IA avec confiance, sans avoir besoin d'un PhD en Machine Learning.
...
**Made with care by [LaFabriqAI](https://lafabriq.ai)**
